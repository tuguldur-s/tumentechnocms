<template>
	<vue-scroll class="page-crypto-dashboard">
		
		<resize-observer @notify="__resizeHanlder" />

		<div id="crypto-banner">
			<ul>
				<li v-for="c in cryptocoins" :key="c.ico" :data-balloon="c.name" data-balloon-pos="down"><i :class="'cc '+c.ico"></i>{{c.price}}</li>
			</ul>
		</div>
		...
		<el-row class="mt-0" :gutter="30">
			<el-col>
				<div class="card-base card-outline">
					<el-row class="mt-0">
						<el-col :xs="24" :sm="24" :md="12" :lg="14" :xl="14" class="wallet-box flex column">
							<div class="select-wallet" :class="{'open':selectWalletOpen}">
								<div class="wallet-item selected flex">
									...
									<div class="coin box grow flex column justify-center">
										...
										<div class="fs-14 balance">
											<span class="o-070 mr-10">balance</span> <span class="accent-text">$ 9404,46</span>
										</div>
									</div>
								...
								<div class="wallet-list">
									<div class="wallet-item flex">
										...
										<div class="coin box grow flex column justify-center">
											<div class="fs-18 title">
												<span class="mr-10">Stellar Wallet</span><span class="o-050 cod">XLM</span>
											</div>
											<div class="fs-14 balance">
												<span class="o-070 mr-10">balance</span> <span class="accent-text">$ 7647,43</span>
											</div>
										</div>
									</div>
									<div class="wallet-item flex">
										...
										<div class="coin box grow flex column justify-center">
											<div class="fs-18 title">
												<span class="mr-10">Litecoin Wallet</span><span class="o-050 cod">LTC</span>
											</div>
											<div class="fs-14 balance">
												<span class="o-070 mr-10">balance</span> <span class="accent-text">$ 247,37</span>
											</div>
										</div>
									</div>
									<div class="wallet-item flex">
								...
								<div class="portfolio box grow flex">
									...
									<div class="price-chart-box">
										<div class="price-chart">
											<div id="priceChart" style="height:170px; width:100%"></div>
										</div>
									</div>
								</div>
								<div class="chart-box">
									<div v-loading="!asyncComponent">
										...
										<component :is="asyncComponent" :type="'line'" :options='{ width: "100%", height: 200, fill: ["rgba(8, 124, 210, 0.25)"], stroke: "rgba(8, 124, 210, 0.75)", strokeWidth: 2 }' :data="[1, 3, 2, 4, 4, 9, 3, 4, 6, 5, 4, 6, 9, 8, 11, 12, 13, 12, 12, 14].toString()"/>
		...
		<el-row class="mt-30" :gutter="30">
			<el-col :xs="24" :sm="12" :md="10" :lg="10" :xl="10" class="conversion-widget">
				...
				<vue-scroll class="card-base card-outline p-10 mb-30" style="height:660px">
					<table class="conversion-table">
						...
						<tbody>
							<tr v-for="(i, index) in conversionHistory" :key="index">
								<td class="text-center tokens"><span>{{i.t_a}}</span><i class="mdi mdi-swap-horizontal"></i><span>{{i.t_b}}</span></td>
			...
			<el-col :xs="24" :sm="12" :md="14" :lg="14" :xl="14" class="conversion-widget">
				...
				<vue-scroll class="card-base card-outline ph-20 pt-5 pb-15 mb-30" style="height:660px">
		...
		<el-row>
			<el-col>
				<div class="card-base card-outline mb-30 candle-chart-box">
					<div class="title card-base card-alt pv-10 ph-15 flex justify-space-between">
						<div class="box grow">
							<h2 class="m-0">BTC/USD</h2>
							<div class="zoom-box">Zoom: 
								<span class="label">1m</span>
								<span class="label selected">3m</span>
						...
						<div class="box grow flex justify-space-between align-center p-10 price-box">
							<div class="flex column">
								<span>Last price</span>
								<strong>$ 8757,57</strong>
							</div>
							<div class="flex column">
								<span>Daily change</span>
								<strong>$ 875,56</strong>
							</div>
							<div class="flex column">
								<span>24h volume</span>
								<strong>BTC 238723</strong>
							</div>
						</div>
					</div>
					<div>
						<div id="candleChart" style="height:570px; width:100%"></div>
					</div>
				</div>
			</el-col>
		</el-row>
			...
			var chartOptions = {
				...
				tooltip: {
					...
					formatter: function(e) {
						...
						return t += "<br/>  Opening : " + e[0].value[0],
...
.wallet-box {
	...
	.select-wallet {
		...
		.wallet-item {
			...
			.arrow {
				background: transparentize($background-color, .9);
				color: transparentize($background-color, .8);
				width: 70px;
				line-height: 70px;
				font-size: 40px;
				cursor: pointer;
...
.candle-chart-box {
	.zoom-box {
		...
		.label {
			...
			&.selected {
				background: transparentize($text-color-accent, .5);
			}
		}
	}
}
