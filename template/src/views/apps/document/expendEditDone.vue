            ...
            <el-row class="items mt-4" :gutter="20">
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb-10">
                    <el-card class="box-card" align="right">
                        <el-button type="success" @click="$router.push('/expends');" plain>Хадгалах</el-button>
                    </el-card>
                </el-col>
                                ...
                                <div>
                                    <el-row>
                                        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
                                            <strong>НХМаягт БМ-3</strong>
                                        </el-col>
                                        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" align="right">
                                            <p style="font-size: 14px; line-height: normal; margin-top: 0px;">Сангийн сайдын 2017 оны 12 дугаар сарын 5<br>өдрийн 347 тоот тушаалын хавсралт</p>
                                        </el-col>
                                    </el-row>
                                </div>		
                                <div class="invoice-top">
                                    ...
                                    <div class="title" align="right">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td align="right" style="width: 60%; padding-right: 10px;"><strong>Гаргасан огноо :</strong></td>
                                                <td style="width: 40%;">
                                                    <el-date-picker size="mini"
                                                    v-model="invoiceTo.date"
                                                    style="width: 100%;"
                                                    type="date"
                                ...
                                <div class="invoice-middle">
                                    ...
                                    <div class="project" align="right">
                                        <table style="line-height: normal; margin-top: 10px; margin-right: 40px;">
                                            ...
                                            <tr>
                                                <td><strong>Байгууллагын нэр: </strong></td>
                                                <td align="right">{{invoiceTo.company}}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Регистрийн дугаар: </strong></td>
                                                <td align="right">{{invoiceTo.register}}</td>
                                            </tr>
                                        </table>
                                    </div>   
                                </div><!--End Invoice Mid-->
...
export default {
    ...
    async beforeRouteLeave (to, from , next) {
      	this.$confirm('Өөрчлөлтийг хадгалах', 'Санамж', {
          ...
          next();
			...
			if(token) {
				this.$axios({
					method: 'post',
					url: rts.$appUrl +`/api/expend/delete-changed-expend`,
					headers: {
						"Authorization": `Bearer ${token}`
					}, 
					data: {
						ordernumber: this.detail.invoiceNumber
					}
				})
				.then(function(data){
					next(); 
    ...
    methods: {
        updateInvoice(done) {
			...
			if(token) {
				this.$axios({
					method: 'post',
					url: rts.$appUrl +`/api/expend/update-expend`,
					headers: {
						"Authorization": `Bearer ${token}`
					},
                    data: {
        ...
        getInvoice() {
			...
			if(token) {
				this.$axios({
					method: 'post',
					url: rts.$appUrl +`/api/expend/get-expend-from-invoice`,
					headers: {
						"Authorization": `Bearer ${token}`
					},
                    data: {
