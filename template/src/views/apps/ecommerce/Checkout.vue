					...
					<el-col v-for="i in items" :key="i.id" :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
						<div class="item mb-20 flex">
							...
							<div class="box grow flex column justify-center">
								...
								<div class="price">{{i.qnt}} x $ {{i.price_text}} = <strong>$ {{i.amount_text}}</strong></div>
							</div>
						</div> 
					</el-col>
				</el-row>
					...
					<div class="box grow flex column mt-40 card">
						...
						<el-row :gutter="20" class="fs-20">
							<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb-20">
								<el-input placeholder="Card number" prefix-icon="mdi mdi-credit-card" v-model="card" class="themed"></el-input>
							</el-col>
							<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
								<el-input placeholder="MM/YY" prefix-icon="mdi mdi-calendar-blank" v-model="date" class="themed"></el-input>
							</el-col>
							<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
								<el-input type="password" placeholder="CVC" prefix-icon="mdi mdi-lock" v-model="cvv" class="themed"></el-input>
							</el-col>
							<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb-20">
								<el-input placeholder="Full name" prefix-icon="mdi mdi-account" v-model="name" class="themed"></el-input>
							</el-col>
						</el-row>
					</div>
